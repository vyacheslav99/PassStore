object FConnectDlg: TFConnectDlg
  Left = 491
  Top = 352
  ...
  object GroupBox1: TGroupBox
    ...
    object lbHint: TLabel
      ...
      Alignment = taCenter
      AutoSize = False
      Caption = #1069#1090#1086' '#1090#1080#1087#1072' '#1086#1075#1088#1086#1084#1085#1072#1103' '#1084#1077#1075#1072' '#1087#1086#1076#1089#1082#1072#1079#1082#1072'. '#1054#1085#1072' '#1090#1077#1073#1077' '#1090#1086#1095#1085#1086' '#1087#1086#1084#1086#1078#1077#1090
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clGray
      Font.Height = -11
      Font.Name = 'Tahoma'
  ...
  object OpenDialog: TOpenDialog
    DefaultExt = 'db'
    Filter = #1041#1072#1079#1099' '#1076#1072#1085#1085#1099#1093' (*.db)|*.db|'#1042#1089#1077' '#1092#1072#1081#1083#1099' (*.*)|*.*'
    FilterIndex = 0
